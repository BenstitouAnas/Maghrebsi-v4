					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li><a href="#"><i class="icon-home4"></i> <span>Acceuil</span></a></li>

								<li>
									<a href="#"><i class="icon-stack2"></i> <span>Roles</span></a>
									<ul>
										<li><a href="./RolesCapacites">Gestion Roles</a></li>
										<li><a href="./Capacites">Gestion Capacite</a></li>
									</ul>
								</li>
								...
								<li>
									...
									<ul>
										<li><a href="#">Liste Commerciaux</a></li>
								...
								<li>
									...
									<ul>
										<li><a href="./Prestataires">Liste Prestataires</a></li>
									</ul>
								</li>
							</ul>
						</div>
